...
describe('DirectiveNodeHandlerAdapter', () => {
  ...
  describe('#getDirectiveConditionalValue', () => {
    ...
    it('should throw if no \'if\' arg is present', () => {
      const directive: DirectiveNode = { kind: 'Directive', name: { kind: 'Name', value: 'skip' }, arguments: [
        {
          kind: 'Argument',
      ...
      expect(() => adapter.getDirectiveConditionalValue(directive, ctx))
